...
amazon.o: mydatastore.cpp amazon.cpp db_parser.h datastore.h product_parser.h 
...
book.o: book.cpp product.h util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c book.cpp
clothing.o: clothing.cpp product.h util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c clothing.cpp
movie.o: movie.cpp product.h util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c movie.cpp
mydatastore.o: mydatastore.cpp datastore.h product.h user.h
